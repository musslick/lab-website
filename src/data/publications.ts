...
export const publications: Publication[] = [
  {
    id: "pub-001",
    title: "Advanced techniques in neural mapping",
    authors: ["Johnson, S.", "Chen, M.", "Smith, R."],
    ...
    keywords: ["Neural Networks", "Brain Imaging", "Computational Modeling"],
    type: "journal",
  ...
  },
  {
    ...
    keywords: ["Neural Networks", "Visualization", "Algorithms"],
    type: "journal",
  ...
  {
    id: "pub-003",
    title: "Cognitive frameworks in machine learning",
    authors: ["Smith, R.", "Wong, E."],
    journal: "AI Journal",
    year: 2023,
    doi: "10.1000/def789",
    ...
    keywords: ["Artificial Intelligence", "Cognitive Science", "Machine Learning"],
    type: "journal",
  ...
  },
  {
    ...
    keywords: ["BCI", "Assistive Technology", "Signal Processing"],
    type: "journal",
  ...
  },
  {
    ...
    keywords: ["Memory", "Neuroplasticity", "Brain Stimulation"],
    type: "journal",
